...
export default function Curve() {
    ...
    return (
        <>
            <div  className={`relative z-10 b-emerald-300 h-[165px] md:flex hidden  w-full `}>
                <svg className={` absolute top-[0px] overflow-visible w-full h-[100px]  b-blue-600 fil-red-300 dark:fill-dark-bg fill-light-bg  `} xmlns="http://www.w3.org/2000/svg">
                    <motion.path
                    d={curvo}
                    transition={{
                        type: "spring",
