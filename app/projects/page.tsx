...
export default function Prjects() {
    ...
    //                 >
    //                     <div className={`w-full h-auto flex flex-col     ${theme == 'dark' ? "bg-dark-bg text-[#fff4f4]" : "bg-light-bg text-[#000000] "} pb-[200px] pt-[100px]`}>
    ...
    //                         </div>
    //                     </div>
    //                     <div className={`w-full h-[300px] relative z-10 ${theme == 'dark' ? "bg-dark-bg " : "bg-light-bg "}`}>
    ...
    return (
        ...
        <motion.div
            ...
            id="page" className="w-full h-auto   mt-[100px]  b-slate-500"
        >
            <div className={`w-full h-auto flex flex-col  z-10  ${theme == 'dark' ? "bg-dark-bg text-[#fff4f4]" : "bg-light-bg text-[#000000] "} pb-[200px] pt-[100px]`}>
                <div className="w-[100%]   b-slate-300 flex flex-col items-center">
            ...
            <div className={`w-full h-[200px] relative z-10 ${theme == 'dark' ? "bg-dark-bg " : "bg-light-bg "}`}>
                <h1 className="text-6xl font-[tommy2] text-center" >
                    More Projects is coming soon
                </h1>
            </div>
